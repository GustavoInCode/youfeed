...
export const Terms: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-16">
      ...
      <p className="text-gray-400 mb-12 italic">Bem-vindo à YouYouTube. Ao usar nossa ferramenta, você concorda com os seguintes termos.</p>
      ...
      <div className="space-y-8 text-gray-400">
        <div className="flex gap-6">
          ...
          <div>
            ...
            <p>Ao instalar a YouYouTube, recebes uma licença limitada, pessoal, não transferível e não exclusiva para utilizar a ferramenta conforme as funcionalidades do teu plano (Free ou PRO). Esta licença destina-se apenas a uso pessoal.</p>
          </div>
        </div>
        ...
        <div className="flex gap-6">
          ...
          <div>
            ...
            <p>A YouYouTube funciona através de técnicas de personalização de interface (CSS e manipulação de DOM). Não nos responsabilizamos por alterações técnicas no YouTube que possam afetar temporariamente o funcionamento da extensão. Faremos o melhor para atualizar a ferramenta rapidamente.</p>
          </div>
        </div>
