...
const faqs = [
  {
    ...
    a: 'A YouYouTube injeta uma interface limpa por cima da Home do YouTube original. Ela filtra os vídeos com base nos perfis e palavras-chave que você define, ocultando o feed infinito e mostrando apenas o que importa.',
  },
  {
    q: 'A YouYouTube coleta meus dados?',
  ...
  },
  {
    ...
    a: 'A YouYouTube foi desenhada para o Chrome, mas é compatível com outros navegadores baseados em Chromium, como Brave, Microsoft Edge e Opera.',
  },
];
